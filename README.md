...
```bash
git clone https://github.com/tetrashop/HybridizerRefrigitz2.git
cd HybridizerRefrigitz2
# دستورات نصب
```
...
- **URL:** [  🚀 دیپلوی HybridizerRefrigitz2 روی Vercel...
    ❌ دیپلوی ناموفق!
...
Vercel CLI 58.5.1 (Node.js 26.4.0)
  ...
  Directory       ~/github/HybridizerRefrigitz2
...
Learn More: https://vercel.com/docs/projects/overview#project-name](  🚀 دیپلوی HybridizerRefrigitz2 روی Vercel...
    ❌ دیپلوی ناموفق!
error: "/data/data/com.termux/files/usr/lib/node_modules/vercel/dist/get-latest-worker.cjs" has bad ELF magic: 2f2a2a0a
Vercel CLI 58.5.1 (Node.js 26.4.0)
...
<!-- Trigger deploy: Mon Aug 17 01:47:48 +0330 2026 -->

## 🌐 دیپلوی

- **URL:** [https://HybridizerRefrigitz2.vercel.app](https://HybridizerRefrigitz2.vercel.app)
- **وضعیت:** ✅ فعال
