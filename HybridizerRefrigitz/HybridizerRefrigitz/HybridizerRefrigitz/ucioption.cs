...
/// insertion order (the idx field) and in the format defined by the UCI protocol.
	...
	public static std.ostream operator << <bool Do>(std.ostream os, SortedDictionary<string, Option, CaseInsensitiveLess> om)
	{

	  for (uint idx = 0; idx < om.Count; ++idx)
	  {
		  foreach (var it in om)
		  {
...
//ORIGINAL LINE: TT.resize(o);
	...
	{
		GlobalMembersMisc.start_logger(o);
	}
