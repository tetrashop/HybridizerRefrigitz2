...
namespace HybridizerRefrigitz
{
	...
	public class Pawn : Stone, IStone
	{
		...
		public int move(Board brd, int x2,int y2)
		{
			...
			if((y==6&&ConsoleColor==2)||(y==1&&ConsoleColor==1))
				n=1;
			...
			if (ConsoleColor == 1 && k > 6 && (x2 == (x + 1) || x2 ==(x - 1)) && y2 == (y + 1))
			{
				return 1;
			}
			if (ConsoleColor == 2 && k != 0 && k < 7 && (x2 == (x - 1) || x2 == (x + 1)) && y2 == (y - 1))
			{
				return 1;
			}
			return 0;
		...
		{
			Point p=brd.searchKing(ConsoleColor);
			King king=new King(ConsoleColor,0,0);
			king.x=p.x;
			king.y=p.y;
	...
	public class Knight: Stone, IStone
	{
		...
		public int move(Board brd, int x2,int y2)
		{
			...
			if (ConsoleColor == 1 && k > 6 && ((v1==2&&v2==1)||(v2==2&&v1==1)))
			{
				return 1;	
			}

			if (ConsoleColor == 2 && k < 7 && ((v1==2&&v2==1)||(v2==2&&v1==1)))
			{
				return 1;	
			}
			return 0;
	...
	public class Castle : Stone, IStone
	{
		...
		public int move(Board brd, int x2, int y2)
		{
			...
			if(k < 7 && ConsoleColor == 2)
			{
				return 1;
			}

			if(k > 6 && ConsoleColor == 1)
			{
				return 1;
			}
			return 0;
	...
	public class King : Stone, IStone
	{
		...
		public int move(Board brd, int x2, int y2)
		{
			...
			i=x2-x;
			j=y2-y;
			if(ConsoleColor==1&&x==4&&y==0&&isChecked(brd)==0&&y2==y)
			{
			...
			else if(ConsoleColor==2&&x==4&&y==7&&isChecked(brd)==0&&y2==y)
			{
		...
		public int isChecked(Board brd2)
		{
			...
			Point p=brd2.searchKing(ConsoleColor);
