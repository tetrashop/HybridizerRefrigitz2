...
namespace GalleryStudio
{
    ...
    public class RefregizMemmory //:AllDraw
    {
        ...
        public HybridizerRefrigitz.AllDraw Load(bool Quantum, int Order)
        {
            Object o = new Object();
            lock (o)
            {
                if (File.Exists(SAllDraw))
                {
                    ...
                    HybridizerRefrigitz.AllDraw tt = new HybridizerRefrigitz.AllDraw(Order, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsT);
        ...
        public void RewriteAllDraw(int Order)
        {
            ...
            lock (oo)
            {
                ...
                //Current = new HybridizerRefrigitz.AllDraw(MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsT);
        ...
        public HybridizerRefrigitz.AllDraw AllDrawCurrentAccess
        {
            get
            { return Current; }
            set
